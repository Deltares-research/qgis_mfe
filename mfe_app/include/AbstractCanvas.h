...
class AbstractCanvas {
    ...
    virtual void drawMultiDot(int nrPoints,
        double* xs/*[nrPoints]*/ , double* ys/*[nrPoints]*/ , int* rgb/*{nrPoints]*/) = 0;

    // Draw a single point with currently set colour by routine fillColor()
    virtual void drawPoint(double x, double y) = 0;

    // Draw an array of points according the given array of colours
    virtual void drawMultiPoint(int nrPoints,
        double* xs/*[nrPoints]*/ , double* ys/*[nrPoints]*/ , int* rgb/*{nrPoints]*/) = 0;
    ...
    virtual void drawPolyline(int nrPoints,
        double* xs/*[nrPoints]*/ , double* ys/*[nrPoints]*/) = 0;
